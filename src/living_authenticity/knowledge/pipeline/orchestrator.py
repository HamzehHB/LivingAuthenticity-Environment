...
class EvidenceFirstPipeline:
    def __init__(self, reader_registry=None, chunker_registry=None, extractor_registry=None,
        ...
        from src.living_authenticity.knowledge.chunking.chunker_registry import ChunkerRegistry as _CR
        from src.living_authenticity.knowledge.classification.rule_based_classifier import DefaultClassifier
        from src.living_authenticity.knowledge.cleaning.cleaner import Cleaner as _Cleaner
        from src.living_authenticity.knowledge.cleaning.normalizer import Normalizer as _Normalizer
        from src.living_authenticity.knowledge.comparison.token_overlap import DefaultComparator
        from src.living_authenticity.knowledge.confidence.evidence_strength import DefaultConfidenceGuard
        from src.living_authenticity.knowledge.core_analysis.token_overlap import DefaultCoreAnalyzer
        from src.living_authenticity.knowledge.extraction.extractor_registry import ExtractorRegistry as _ER
        from src.living_authenticity.knowledge.metadata.extractor import MetadataExtractor as _ME
        ...
        from src.living_authenticity.knowledge.relations.token_overlap import DefaultDetector
        from src.living_authenticity.knowledge.retrieval.token_overlap import DefaultRetriever
