...
def build_audit_record(request, outcome, revalidation=None, execution=None,
    ...
    """
    from src.living_authenticity.knowledge.approval.outcome import (
        ApprovalOutcome,
        ApprovalRequest,
    )
    ...
    if revalidation is not None:
        from src.living_authenticity.knowledge.revalidation.outcome import (
            RevalidationResult,
        )
    ...
    if execution is not None:
        from src.living_authenticity.knowledge.execution.outcome import (
            ExecutionResult,
        )
