...
class TestNoSideEffects:
    _MODULES = (
        "src.living_authenticity.knowledge.comparison.base_comparator",
        "src.living_authenticity.knowledge.comparison.outcome",
        "src.living_authenticity.knowledge.comparison.token_overlap",
        "src.living_authenticity.knowledge.comparison.comparator_registry",
    )
