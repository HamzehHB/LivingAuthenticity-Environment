...
from src.living_authenticity.knowledge.governance.approval.outcome import ApprovalRequest
...
def test_schema_state_valid_and_empty_pass_through():
    ...
    from src.living_authenticity.knowledge.governance.revalidation import current_schema_version
    _, _, proposal, conf, request, outcome = _approved()
    ...
    real_path = Path(__file__).resolve().parents[2] / "Knowledge-Schema.yaml"
...
def test_no_execution_or_filesystem_effects():
    import pathlib
    import src.living_authenticity.knowledge.governance.revalidation.revalidator as mod
