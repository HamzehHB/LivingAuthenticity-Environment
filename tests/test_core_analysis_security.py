...
from src.living_authenticity.knowledge.core_analysis import TokenOverlapCoreAnalyzer
...
class TestNoSideEffects:
    _MODULES = (
        "src.living_authenticity.knowledge.core_analysis.base_analyzer",
        "src.living_authenticity.knowledge.core_analysis.outcome",
        "src.living_authenticity.knowledge.core_analysis.token_overlap",
        "src.living_authenticity.knowledge.core_analysis.analyzer_registry",
    )
