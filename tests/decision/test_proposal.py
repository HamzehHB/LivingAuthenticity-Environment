...
from src.living_authenticity.knowledge.decision.proposal.registry import ProposalRegistry
from src.living_authenticity.knowledge.analysis.relations.outcome import (
    ProposedRelation,
    RelationDetectionResult,
)
from src.living_authenticity.knowledge.analysis.retrieval.candidate import (
    RetrievedCandidate,
)
