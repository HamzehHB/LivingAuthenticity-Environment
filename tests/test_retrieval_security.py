...
class TestRetrievalPerformsNoSideEffects:
    _MODULES = (
        "src.living_authenticity.knowledge.retrieval.candidate",
        "src.living_authenticity.knowledge.retrieval.result",
        "src.living_authenticity.knowledge.retrieval.base_retriever",
        "src.living_authenticity.knowledge.retrieval.store",
        "src.living_authenticity.knowledge.retrieval.token_overlap",
        "src.living_authenticity.knowledge.retrieval.retriever_registry",
    )
