...
from src.living_authenticity.knowledge.comparison import (
...
class TestContract:
    def test_abstract(self):
        from src.living_authenticity.knowledge.comparison import KnowledgeComparator
        with pytest.raises(TypeError):
            KnowledgeComparator()  # type: ignore[abstract]

    def test_registry(self):
        from src.living_authenticity.knowledge.comparison import ComparatorRegistry
    ...
    def test_end_to_end(self):
        from src.living_authenticity.knowledge.retrieval import TokenOverlapRetriever
