...
from src.living_authenticity.knowledge.comparison import TokenOverlapComparator
from src.living_authenticity.knowledge.extraction.knowledge_unit import KnowledgeUnit
from src.living_authenticity.knowledge.relations import TokenOverlapRelationDetector
from src.living_authenticity.knowledge.retrieval import RetrievedCandidate
...
class TestNoSideEffects:
    _MODULES = (
        "src.living_authenticity.knowledge.relations.base_detector",
        "src.living_authenticity.knowledge.relations.outcome",
        "src.living_authenticity.knowledge.relations.token_overlap",
        "src.living_authenticity.knowledge.relations.detector_registry",
    )
